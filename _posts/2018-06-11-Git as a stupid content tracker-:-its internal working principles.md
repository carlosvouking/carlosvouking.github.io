...
Git not only maps keys and their contents, it also tracks contents of files and directories. To understand its file tracking asset, I will build a project that will be exposed to git. 
